package androidluckyguys.baselibrary;
...
// Change text color
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newJuneRegular = Typeface.createFromAsset(getAssets(), "fonts/fontawesome-webfont.ttf");

        Mint.initAndStartSession(this.getApplication(), "dff55a0a");
